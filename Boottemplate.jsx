    ...
    return (
        ...
        <div id="sec3">
          <Container>
            ...
            <Row>
              <Col>
               <Card style={{ width: '20rem' }} className='mt-4 bg-light col-4 mx-auto' data-aos="zoom-in">
                <Card.Img variant="top" src="../public/portfolio/1.jpg" className='ps-2 pe-2' />
                <Card.Body>
            ...
            <Col>
               <Card style={{ width: '20rem' }} className='mt-4 bg-light col-4 mx-auto' data-aos="zoom-in">
                <Card.Img variant="top" src="../public/portfolio/2.jpg" className='ps-2 pe-2' />
                <Card.Body>
               ...
               <Card style={{ width: '20rem' }} className='mt-4 bg-light col-4 mx-auto' data-aos="zoom-in">
                <Card.Img variant="top" src="../public/portfolio/3.jpg" className='ps-2 pe-2' />
                <Card.Body>
            ...
            <Row>
              <Col>
               <Card style={{ width: '20rem' }} className='mt-4 bg-light col-4 mx-auto' data-aos="zoom-in">
                <Card.Img variant="top" src="../public/portfolio/4.jpg" className='ps-2 pe-2' />
                <Card.Body>
            ...
            <Col>
               <Card style={{ width: '20rem' }} className='mt-4 bg-light col-4 mx-auto' data-aos="zoom-in">
                <Card.Img variant="top" src="../public/portfolio/5.jpg" className='ps-2 pe-2' />
                <Card.Body>
            ...
            <Col>
               <Card style={{ width: '20rem' }} className='mt-4 bg-light col-4 mx-auto' data-aos="zoom-in">
                <Card.Img variant="top" src="../public/portfolio/6.jpg" className='ps-2 pe-2' />
                <Card.Body>
        ...
        <div id="sec4">
          <Container>
            ...
            <div className="timeline-item mb-5">
              <img src="../public/about/1.jpg" alt="" />
            </div>
            <div className="timeline-item mt-5 mb-5">
              <img src="../public/about/2.jpg" alt="" />
            </div>
            <div className="timeline-item mt-5 mb-5">
              <img src="../public/about/3.jpg" alt="" />
            </div>
            <div className="timeline-item mt-5">
              <img src="../public/about/4.jpg" alt="" />
            </div>
            </div>
          </Container>
        </div>
          ...
          <Container>
            ...
            <p className='mt-4 p-2 fst-italic text-secondary fw-bolder text-center'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Corporis, unde?</p>
              ...
              <Col>
               <Card style={{ width: '15rem' }} className='mt-4 border border-light col-4 mx-auto my-2' data-aos="fade-right">
                <Card.Img variant="top" src="../public/team/1.jpg" className='rounded-circle border border-5' />
                <Card.Body>
                 ...
                 <Card.Text className='ms-0 text-center bg-light text-secondary w-100'>
                  ...
                  <img src="../public/icons/twitter.svg" alt=""className='img-fluid icon pt-3 icon-hover' />
                   <img src="../public/icons/facebook.svg" alt=""className='img-fluid ms-4 icon pt-3 icon-hover' />
                   <img src="../public/icons/linkedin.svg" alt="" className='img-fluid ms-4 icon pt-3 icon-hover' />
               </Card.Body>
            </Card>
            </Col>
            <Col>
               <Card style={{ width: '15rem' }} className='mt-4 border border-light col-4 mx-auto my-2' data-aos="fade-up">
                <Card.Img variant="top" src="../public/team/2.jpg" className='rounded-circle border border-5' />
                <Card.Body>
            ...
            <Col>
               <Card style={{ width: '15rem' }} className='mt-4 border border-light col-4 mx-auto my-2' data-aos="fade-left">
                <Card.Img variant="top" src="../public/team/3.jpg" className='rounded-circle border border-5' />
                <Card.Body>
